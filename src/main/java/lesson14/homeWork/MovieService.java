...
public class MovieService {
    ...
    public List<Movie> findMoviesAboveGiveYearMargin(ArrayList<Movie> movies, Year inputFirstYear, Year inputSecondYear) {
        ...
        List<Movie> mBetween = movies.stream()
                .filter(movie -> movie.getYear().isAfter(inputFirstYear) && movie.getYear().isBefore(inputSecondYear))
    ...
    public List<Movie> findMovieByName(ArrayList<Movie> movies,String movieTofFind) {
    ...
    public List<Movie> findMoviesAboveGivenBudget(ArrayList<Movie> movies, Integer inputMargin) {
